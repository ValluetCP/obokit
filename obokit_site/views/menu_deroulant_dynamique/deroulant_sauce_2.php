...
var gazeuseBoissonRadio = document.getElementById('maison_sauce');
...
if (gazeuseBoissonRadio.checked && sauceMaisonSelect.value === "0") {
...
if (autreSauceRadio.checked && sauceAutreSelect.value === "0") {
    ...
    // sauceBokitSelect.addEventListener('change', afficherMenu);
    // sauceMaisonSelect.addEventListener('change', afficherMenu);
    // sauceAutreSelect.addEventListener('change', afficherMenu);
